...
// batasi akses hanya untuk yang punya akses 'admin' (bukan lab)
if(!isset($_SESSION['log']) || $_SESSION['akses'] != 'admin'){
    // jika bukan admin, langsung arahkan ke lab.php (atau login)
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Klasifikasi Rumah</h1>
                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                        $ambilsemuadataklasifikasi = mysqli_query($conn, "select * from klasifikasi");
                                        $i= 1;
                                        while($data=mysqli_fetch_array($ambilsemuadataklasifikasi)){
                                        ...
                                        <!-- Modal body -->
                                            ...
                                            <div class="modal-body">
                                                <input type="text" name="tipe_bangunan" value="<?=$tipe_bangunan;?>" class="form-control" required>
                                                <br>
                                                <input type="text" name="alamat" value="<?=$alamat;?>" class="form-control" required>
                                                <br>
                                                <input type="text" name="tarif" value="<?=$tarif;?>" class="form-control" required>
                                                <br>
                                        ...
                                        <div class="modal fade" id="delete<?=$id;?>">
                                            ...
                                            <form method="post">
                                        <div class="modal-body">
                                            Apakah Anda yakin ingin menghapus <?=$tipe_bangunan;?>?
                                            <input type="hidden" name="id" value="<?=$id;?>">
                                            <br>
                                            <br>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Dinas Lingkungan Sampah 2025</div>
                            <div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
       <form method="post">
  <div class="modal-body">
    <input type="text" name="tipebangunan" placeholder="Tipe Bangunan" class="form-control" required>
    <br>
    <input type="number" name="tarif" class="form-control" placeholder="Tarif" required>
    <br>
    <input type="text" name="alamat" placeholder="Alamat" class="form-control" required>
    <br>
    <input type="text" name="keterangan" placeholder="Keterangan Data" class="form-control" required>
    <br>
    <button type="submit" class="btn btn-primary" name="addnewdata_klasifikasi">Submit</button>
  </div>
</form>
